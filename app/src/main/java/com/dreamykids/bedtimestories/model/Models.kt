...
data class SettingsState(val darkMode:Boolean=true,val playbackSpeed:Float=1f,val autoPlayNext:Boolean=true,val rememberLastStory:Boolean=true,val notifications:Boolean=false)
